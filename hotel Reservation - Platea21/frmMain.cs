...
#region Default Instance
		...
		{
			string out_app = System.Convert.ToString(Interaction.MsgBox("¿Cerrar Sesión?", (int) Constants.vbQuestion + Constants.vbYesNo, "Cerrar Sesión"));
		...
		{
			string out_app = System.Convert.ToString(Interaction.MsgBox("¿Cerrar Sesión del Sistema?", (int) Constants.vbQuestion + Constants.vbYesNo, "Cerrar Sesión"));
			if (out_app == Constants.vbYes.ToString())
			{
				this.Hide();
