...
namespace HBRS
{
	public partial class frmCheckOutList
	{
		public frmCheckOutList()
		{
			InitializeComponent();
...
#region Default Instance
		...
		private static frmCheckOutList defaultInstance;
		
		
		public static frmCheckOutList Default
		{
			get
			{
				if (defaultInstance == null)
				{
					defaultInstance = new frmCheckOutList();
		...
		public void frmCheckOutList_Load(System.Object sender, System.EventArgs e)
		{
			...
			Module1.rs = new OleDbDataAdapter("Select * from tblTransaction, tblGuest, tblDiscount, tblRoom WHERE tblTransaction.GuestID = tblGuest.ID AND tblTransaction.DiscountID = tblDiscount.ID AND tblTransaction.RoomNum = tblRoom.RoomNumber AND tblTransaction.Remarks = \'Checkout\' AND tblTransaction.Status = \'Activo\'", Module1.con);
			Module1.rs.Fill(Dt);
