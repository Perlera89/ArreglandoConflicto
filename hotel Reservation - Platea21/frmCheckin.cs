        ...
        public void bttnCheckIn_Click_1(System.Object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                if (a == Constants.vbYes.ToString())
                {
                    ...
                    {
                        Interaction.MsgBox("Checkin de Huésped Exitoso! " + "Cambiar: $ " + Conversion.Val(System.Convert.ToString(Conversion.Val(txtAdvance.Text) - Conversion.Val(txtSubTotal.Text))).ToString("00.00"), Constants.vbInformation, "Check In");
                    ...
                    {
                        Interaction.MsgBox("Checkin de Huésped Exitoso!", Constants.vbInformation, "Check In");
                    }
